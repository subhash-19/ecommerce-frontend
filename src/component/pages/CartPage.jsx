...
const CartPage = () => {
    ...
    return (
        <div className="max-w-[800px] mx-auto mb-40 p-5 text-[#444]">
                ...
                <div>
                    <ul className="list-none p-0">
                        {cart.map(item => (
                            <li
                                key={item.id}
                                className="border border-gray-300 rounded-md mb-5 p-3 flex items-center"
                            >
                                <img
                                    src={item.imageUrl}
                                    alt={item.name}
                                ...
                                <div className="flex-1">
                                    ...
                                    <span className="block mt-2 font-medium">${item.price.toFixed()}</span>
                                </div>
                            </li>
                        ))}
                    </ul>
                    ...
                    <h2 className="text-xl font-bold mt-4">
                            Total: ${new Intl.NumberFormat('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(totalPrice)}
                        </h2>
                    <button
